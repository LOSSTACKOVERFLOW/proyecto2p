# Generated by Django 2.1.7 on 2019-08-15 22:42
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='persona',
            name='Contacto',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.Contacto'),
        ),
        migrations.AddField(
            model_name='detalle_orden_menu',
            name='Orden_Menu',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.Orden_Menu'),
        ),
        migrations.AddField(
            model_name='detalle_orden_menu',
            name='Producto',
