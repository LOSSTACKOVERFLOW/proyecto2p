    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Contacto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.Contacto')),
            ],
        ),
        migrations.CreateModel(
            name='Cliente',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Descripcion', models.CharField(max_length=800)),
                ('Orden_Menu', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.Orden_Menu')),
